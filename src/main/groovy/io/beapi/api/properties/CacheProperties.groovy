...
@PropertySources([
        @PropertySource(value="classpath:beapi_cache.yaml", factory=YamlPropertySourceFactory.class),
...
public class CacheProperties {
    ...
    public ThrottleProps throttle = new ThrottleProps()
    ...
    public static class ThrottleProps {
        private Long diskExpiryThreadIntervalSeconds
        private Integer maxEntriesLocalHeap
        private Integer maxEntriesLocalDisk
